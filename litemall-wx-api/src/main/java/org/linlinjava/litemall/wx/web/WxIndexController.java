...
public class WxIndexController {
    ...
    public Object index() {
        //pyramidService.calcSell(new BigDecimal("168.00"),12);
        pyramidService.calcAgency((byte) 2,new BigDecimal("300"),12);
        pyramidService.calcAgency((byte) 3,new BigDecimal("6800"),12);
