...
<script>
import { listCommission, createCommission, updateCommission, deleteCommission } from '@/api/commission'
  ...
  methods: {
    ...
    createData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          createCommission(this.dataForm)
            .then(response => {
    ...
    updateData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          updateCommission(this.dataForm)
            .then(() => {
